  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        AppCard(
          child: Column(
            ...
            children: [
              ...
              Text('Version 0.18.0 - licence MIT',
        ...
        const _Fact('Labo', 'En-tete decode, coinbase lue, console Stratum, avalanche'),
        ...
        const _Fact('Portefeuille', 'BIP39 + BIP84, coffre securise local, reception bc1q'),
